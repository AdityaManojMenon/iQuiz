...
export async function POST(req: NextRequest) {
    ...
    try {
        ...
        const extractionFunctionSchema = {
            name: "extractor", // Add the 'name' field here
        ...
        const runnable = model
            .bind({
                ...
                function_call: { name: "extractor" }, // Ensure this matches the 'name' in the schema
            })
            .pipe(parser);
        ...
        // Return the full JSON structure as a response
